...
bool Renderer::StartUp(TextureManager* texMan, MeshManager* mesMan)
{

	if (texMan == NULL)
	{
		printf("\n Error: NULL textureManager passed");
		return false;
	}
	textureMan = texMan;
